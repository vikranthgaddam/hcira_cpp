...
private:
    ...
    void OnLeftUp(wxMouseEvent& event)
    {
		...
		vector<Point> s = ConvertToPointVector(m_points);
		sample.Recognize(s,true);
        ReleaseMouse();
        Refresh();
    }
	...
	std::vector<Point> ConvertToPointVector( std::vector<wxPoint>& wx_points) {
		std::vector<Point> points;
		points.reserve(wx_points.size());
		for (const auto& wx_point : wx_points) {
			points.push_back({ wx_point.x, wx_point.y });
		}
		return points;
	}
...
public:
	...
	Point(87, 142), Point(89, 145), Point(91, 148), Point(93, 151),
	Point(96, 155), Point(98, 157), Point(100, 160), Point(102, 162),
	Point(106, 167), Point(108, 169), Point(110, 171), Point(115, 177),
	Point(119, 183), Point(123, 189), Point(127, 193), Point(129, 196),
	Point(133, 200), Point(137, 206), Point(140, 209), Point(143, 212),
	Point(146, 215), Point(151, 220), Point(153, 222), Point(155, 223),
	Point(157, 225), Point(158, 223), Point(157, 218), Point(155, 211),
	Point(154, 208), Point(152, 200), Point(150, 189), Point(148, 179),
	Point(147, 170), Point(147, 158), Point(147, 148), Point(147, 141),
	Point(147, 136), Point(144, 135), Point(142, 137), Point(140, 139),
	Point(135, 145), Point(131, 152), Point(124, 163), Point(116, 177),
	Point(108, 191), Point(100, 206), Point(94, 217), Point(91, 222),
